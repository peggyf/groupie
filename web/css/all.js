...
$.tablesorter.addWidget({
  ...
  $.tablesorter.addWidget({
    id: "zebra3",
    format: function(table) {
      $("td",table.tBodies[0]).each(function(){ $(this).addClass("TabInfos"); $(this).attr("style",""); });
			$("tr",table.tBodies[0]).each(function(){ $(this).removeClass("even"); $(this).removeClass("odd");});
			$("tr:odd",table.tBodies[0]).each(function(){ $(this).addClass("odd");});
			$("tr:even",table.tBodies[0]).each(function(){ $(this).addClass("even");});
    }
  }); 
var amu={
